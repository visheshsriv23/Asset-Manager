...
Concrete fixes for the trust-boundary categories named in `SKILL.md`. These are prevention patterns, not a ranking — for the 2021 severity ordering, see `security-checklist.md`.
